...
OPTIONS := -Wall
#ALLEGRO
tetris_al: main.o element_al.o highscore_al.o buttons_al.o menu_al.o game_sel_al.o game_al.o highscore.o rules.o game.o highscore.txt
	${CC} main.o element_al.o highscore_al.o buttons_al.o menu_al.o game_sel_al.o game_al.o highscore.o rules.o game.o -o tetris_al ${OPTIONS_AL}
main.o: main.c element_al.h menu_al.h game_sel_al.h highscore_al.h game_state.h highscore.h
	${CC} main.c -c ${OPTIONS_AL}
